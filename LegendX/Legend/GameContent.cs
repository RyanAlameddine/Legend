...
namespace Legend
{
    public static class GameContent
    {
        ...
        public static void LoadContent(ContentManager content){
            ...
            GameContent.grassbarrier = content.Load<Texture2D>("obstacles/grassyrock");
            GameContent.portal = content.Load<Texture2D>("objects/swirl portal");
            GameContent.skyportal = content.Load<Texture2D>("objects/sky portal");
        ...
        public static void Loadxml(ContentManager Content)
        {
            ...
            GameApplication.xmlDoc = new XmlDocument();
            GameApplication.xmlDoc.Load(GameApplication.saveFile);
        }
    }
}
