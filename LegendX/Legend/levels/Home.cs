...
namespace Legend
{
    public class Home
    {
        ...
        public void Update()
        {
            ...
            {
                GameApplication.screen = Screens.Intro;
            }
            if (continuebutton.buttonpressed() && GameApplication.xmlDoc.GetElementsByTagName("user")[0] != null)
            {
                GameApplication.screen = Screens.Continue;
            }
        }
        ...
        public void Draw(SpriteBatch spriteBatch)
        {
            ...
            if (GameApplication.xmlDoc.GetElementsByTagName("user")[0] != null)
            {
