...
namespace Legend
{
    public class Inventory
    {
        ...
        {
            int lvl = GameApplication.level;
            if (GameApplication.screen != Screens.Level || lvl == 0)
            {
                lvl++;
            }
            sword = new Sword(weapon.texture, GameApplication.levellist[lvl - 1].player, new Vector2(15, 25));
        }
