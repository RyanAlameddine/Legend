...
namespace Legend.weapons
{
    public class Sword
    {
        ...
        public void Update()
        {
            if (GameApplication.levellist[GameApplication.level - 1].enemies.Count > 0)
            {
                foreach (Enemy e in GameApplication.levellist[GameApplication.level - 1].enemies)
                {
                    ...
                    {
                        GameApplication.levellist[GameApplication.level - 1].enemyHit(GameApplication.levellist[GameApplication.level - 1].enemies.IndexOf(e));
                    }
                }
            }
